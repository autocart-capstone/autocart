...
while true
    ...
    [x, y] = position(floats(1:2:end),floats(2:2:end),structures,test_pos,angle,measures,walls);
    write(t,[x y])
...
function [xa,ya] = position(theta, distances,structures,test_pos,angle,measures,walls)
