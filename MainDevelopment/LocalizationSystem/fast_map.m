...
% 
% Convert structure polygons into a big list of line segments, I understand
% this to be to create a line between a point and the next point
...
for np = 1:N_real
    ...
    xa1 = walls(1,pidx) + abs(real_data(1, 19)); %left wall
    xa2 = walls(3,pidx) - abs(real_data(1,  1)); %%right wall
